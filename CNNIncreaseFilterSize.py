...
# CNN Architecture with Increased Filter Size
model = Sequential()
model.add(Conv1D(filters=64, kernel_size=5, activation='relu', input_shape=(X_train_scaled.shape[1], 1)))  # Increased filter size to 5
