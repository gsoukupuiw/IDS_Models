...
# DNN Architecture for Increased Width
model = Sequential()
model.add(Dense(2048, activation='relu', input_shape=(X_train_scaled.shape[1],)))  # Increased to 2048 neurons
model.add(Dropout(0.25))
model.add(Dense(1024, activation='relu'))  # Increased to 1024 neurons
model.add(Dropout(0.25))
model.add(Dense(512, activation='relu'))   # Increased to 512 neurons
...
# Save the model
model.save("DNNIncreasedWidth.h5")