...
# DNN Architecture with Sigmoid Activation Function
model = Sequential()
model.add(Dense(1024, activation='sigmoid', input_shape=(X_train_scaled.shape[1],)))  # Sigmoid activation
model.add(Dropout(0.25))
model.add(Dense(512, activation='sigmoid'))  # Sigmoid activation
model.add(Dropout(0.25))
model.add(Dense(256, activation='sigmoid'))  # Sigmoid activation
